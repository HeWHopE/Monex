...
const MainPage = () => {
  ...
  const RightIcon = (
    <div className="  flex items-center  justify-center">
      <div className="bg-white rounded-lg p-[6px]">
        <svg
          width="25"
          height="25"
          viewBox="0 0 35 35"
  ...
  return (
    <div className="flex items-center h-screen justify-center w-screen  flex-col ">
      ...
      {/* Main Container */}
      <div className="w-full z-99  max-w-sm mx-auto font-main py-0 lg:py-7 px-2 bg-red-800 rounded-2xl overflow-hidden shadow-2xl md:min-w-[30rem] pb-4 md:h-min-[10px]">
        {/* Header Section */}
        ...
        <div className="px-4 py-0 space-y-4 sm:py-4">
          ...
          >
            ...
            <div className="flex flex-row justify-between w-full">
              <div>
                <p className="sm:text-xs text-[12px]  font-semibold">
                  Кеш ⇄ USDT
                </p>
